...
CMD ["sh", "-c", "npx prisma migrate resolve --rolled-back 20260429000000_add_multicurrency_overtime 2>/dev/null || true && npx prisma migrate deploy && node .next/standalone/server.js"]
